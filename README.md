...
## raylib-go
[![Build Status](https://github.com/centretown/raylib-go/actions/workflows/build.yml/badge.svg)](https://github.com/centretown/raylib-go/actions)
[![GoDoc](https://godoc.org/github.com/centretown/raylib-go/raylib?status.svg)](https://godoc.org/github.com/centretown/raylib-go/raylib)
[![Go Report Card](https://goreportcard.com/badge/github.com/centretown/raylib-go/raylib)](https://goreportcard.com/report/github.com/centretown/raylib-go/raylib)
[![Examples](https://img.shields.io/badge/learn%20by-examples-0077b3.svg?style=flat-square)](https://github.com/centretown/raylib-go/tree/master/examples)
...
[Android example](https://github.com/centretown/raylib-go/tree/master/examples/others/android/example).

### Installation

    go get -v -u github.com/centretown/raylib-go/raylib
...
Documentation on [GoDoc](https://godoc.org/github.com/centretown/raylib-go/raylib). Also check raylib [cheatsheet](http://www.raylib.com/cheatsheet/cheatsheet.html). If you have problems or need assistance there is an active community in the #raylib-go channel of the [Raylib Discord Server](https://discord.gg/raylib) that can help.
...
Check more [examples](https://github.com/centretown/raylib-go/tree/master/examples) organized by raylib modules.
...
raylib-go is licensed under an unmodified zlib/libpng license. View [LICENSE](https://github.com/centretown/raylib-go/blob/master/LICENSE).
